...
def class_text_to_int(row_label):
    if row_label =='Jenis Benda: Benda Tajam':
        return 1
    elif row_label =='Nama Benda: Pisau':
        return 2
    if row_label =='Jenis Benda: Benda Tajam':
        return 3
    elif row_label =='Nama Benda: Pisau':
        return 4
    elif row_label =='Jenis Benda: Narkotika dan Narkoba':
        return 7
    elif row_label =='Nama Benda: Sabu-sabu':
        return 8
    elif row_label =='Jenis Benda: Narkotika dan Narkoba':
        return 7
    elif row_label =='Nama Benda: Sabu-sabu':
